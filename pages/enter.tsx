		...
		<div className="mt-16 px-24">
			...
			<div className="mt-16">
				<div className="flex flex-col items-center">
					...
					<div className="grid w-full border-b mt-8 grid-cols-2 gap-16">
						<button
							className={cls(
				...
				<form className="flex flex-col mt-8">
					...
					<button className="mt-5 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:right-2 focus:ring-offset-2 focus:ring-orage-500 focus:outline-none">
