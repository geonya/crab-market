...
const EditProfile: NextPage = () => {
	return (
		<div className="px-4 py-10 space-y-4">
			...
			<button className="mt-5 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:right-2 focus:ring-offset-2 focus:ring-orage-500 focus:outline-none">
				Update Profile
			</button>
		</div>
	);
