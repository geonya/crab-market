...
export default function LayOut({
	...
	return (
		<div>
			...
			{hasTabBar ? (
				<nav className='bg-white text-xs max-w-xl w-full text-gray-700 border-t fixed bottom-0 px-10 pb-5 pt-3 flex justify-between items-center'>
					<Link href='/'>
						<a
							className={cls(
